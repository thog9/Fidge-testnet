...
╚═╝░░░░░╚═╝╚═════╝░░╚═════╝░╚══════╝  ░░░╚═╝░░░╚══════╝╚═════╝░░░░╚═╝░░░╚═╝░░╚══╝╚══════╝░░░╚═╝░░░
    ...
    print_border("FIDGE TESTNET", Fore.GREEN)
...
async def run_spinner(language: str):
    from scripts.spinner import run_spinner as spinner_run
    await spinner_run(language)
...
def get_available_scripts(language):
    scripts = {
        'vi': [            
            {"name": "1. Tự động Sync + Convert + Wheel + Watch Ad", "value": "spinner"},
            {"name": "2. Tự động Coupon → Redeem Code", "value": "redeem"},
            
            {"name": "X. Thoát", "value": "exit"},
        ],
        'en': [            
            {"name": "1. Automatic Sync + Convert + Wheel + Watch Ad ", "value": "spinner"},
            {"name": "2. Automatic Coupon → Redeem Code", "value": "redeem"},
